...
from datasets.dataset import PHLADataset
from torch.utils.data import DataLoader
from models.models import PHLAModel
...
def train_valid_pHLA(config, config_model):
    ...
    logger = Logger(config["logPath"] + "train_pHLA.log")
...
if __name__ == "__main__":
    ...
    test_performance, external_performance = train_valid_pHLA(config, config_model)
    ...
    all_performance.to_csv(config["logPath"] + "performance_pHLA.csv")
